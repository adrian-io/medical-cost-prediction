...
pickle.dump(gs_cv, open("svm.sav", "wb"))
```
...
pickle.dump(gs_cv, open("rand_forest_class.sav", "wb"))
```
...
pickle.dump(gs_cv, open("grad_boost_class.sav", "wb"))
```
...
print(cm)
class_model = pickle.load(open(cm+".sav", "rb"))
print(class_model)
...
pickle.dump(gs_cv, open("ridge_x_terms.sav", "wb"))
```
...
pickle.dump(clusteredRidge, open("clustered_ridge.sav", "wb"))
```
...
pickle.dump(gs_cv, open("lasso.sav", "wb"))
```
...
pickle.dump(statsmod, open("ols_regression.sav", "wb"))
```
...
pickle.dump(gs_cv, open("random_forest_reg.sav", "wb"))
```
...
pickle.dump(gs_cv, open("gradient_boosting_reg.sav", "wb"))
```
...
pickle.dump(ridge_reg, open("ridge_single.sav", "wb"))
```
...
pickle.dump(gs_cv, open("rand_forest_reg_single.sav", "wb"))
```
...
pickle.dump(gs_cv, open("grad_boost_reg_single.sav", "wb"))
```
...
#         print(y_test[0:10])
        if rm == "neural_net":
            ...
            reg_model = pickle.load(open(rm+".sav", "rb"))
